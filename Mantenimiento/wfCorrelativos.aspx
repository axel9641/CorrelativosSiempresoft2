<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="wfCorrelativos.aspx.cs" Inherits="Mantenimiento_wfCorrelativos" %>
...
<div class="dvModuloContenido"><center>.:: CONTROL DE CORRELATIVOS ::.</center></div>
            ...
            <tr>
                <td align="left">
                    ...
                    <asp:LinkButton ID="lblNuevo" runat="server" onclick="lblNuevo_Click"  style="color:White;" >
                        <span style="height:200px"><img class="imgLink"  src="../images/nueva_prop.png" alt="Pedir un nuevo Correlativo" />Pedir un nuevo Correlativo</span>
                    </asp:LinkButton>                    
                    </span>
...
<!-- VENTANA DE Detalle-->
            ...
            <asp:Panel ID="pnDetalle" Style="display: none;" runat="server" CssClass="pnlVentana" Width="1024px" Height="620px" ScrollBars="Auto" >
                ...
                <asp:Panel ID="pnPanelInsercionDetalle" runat="server">
                    ...
                    <asp:Panel ID="pnListadoDetalle" runat="server" Width="100%" Height="400px" ScrollBars="Vertical"  style="margin:10px 0 0 0;" >
